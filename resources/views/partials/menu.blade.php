    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('setting_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/expense-categories*") ? "menu-open" : "" }} {{ request()->is("admin/income-categories*") ? "menu-open" : "" }} {{ request()->is("admin/depositors*") ? "menu-open" : "" }} {{ request()->is("admin/accounts*") ? "menu-open" : "" }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('depositor_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.depositors.index") }}" class="nav-link {{ request()->is("admin/depositors") || request()->is("admin/depositors/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">

                                        </i>
                                        <p>
                                            {{ trans('cruds.depositor.title') }}
                                        </p>
                                    </a>
                                </li>
                            @endcan
                ...
                @can('deposit_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.deposits.index") }}" class="nav-link {{ request()->is("admin/deposits") || request()->is("admin/deposits/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">
