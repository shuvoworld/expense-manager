    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-depositorDeposits">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($deposits as $key => $deposit)
                            <tr data-entry-id="{{ $deposit->id }}">
                                ...
                                <td>
                                    {{ $deposit->account->opening_balance ?? '' }}
                                </td>
                                <td>
                                    @can('deposit_show')
...
@endcan
  ...
  let table = $('.datatable-depositorDeposits:not(.ajaxTable)').DataTable({ buttons: dtButtons })
