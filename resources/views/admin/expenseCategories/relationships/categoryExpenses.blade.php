    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-categoryExpenses">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.expense.fields.account') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($expenses as $key => $expense)
                            <tr data-entry-id="{{ $expense->id }}">
                                ...
                                <td>
                                    {{ $expense->account->opening_balance ?? '' }}
                                </td>
                                <td>
                                    {{ $expense->description ?? '' }}
                                </td>
...
@endcan
  ...
  let table = $('.datatable-categoryExpenses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
